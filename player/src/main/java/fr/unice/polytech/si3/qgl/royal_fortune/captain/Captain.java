...
public class Captain {
    ...
    public void associateSailorToOar(double orientation){
        ...
        ArrayList<Oar> oarList = ship.getOarListByOrientation(orientation < 0 ? "right" : "left");
        int i = 0;
    ...
    public void associateSailorToOarEvenly(){
        ArrayList<Oar> leftOarList = ship.getOarListByOrientation("left");
        ArrayList<Oar> rightOarList = ship.getOarListByOrientation("right");
        int oarIndex = 0;
        int sailorIndex = 0;
