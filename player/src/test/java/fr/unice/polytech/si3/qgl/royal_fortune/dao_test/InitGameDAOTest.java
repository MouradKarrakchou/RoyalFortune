...
public class InitGameDAOTest {
    private InitGameDAO initdao;
    @BeforeEach
    void init(){
        ...
        initdao = JsonManager.readInitGameDAOJson(json);
    }

    @Test
    void getShipCountTest(){
        assertEquals(1, initdao.getShipCount());
    }

    @Test
    void getWindTest(){
        Wind w = new Wind(0,5.);
        initdao = new InitGameDAO(null, null, null, 0, w);
        assertEquals(5., initdao.getWind().getStrength());
    }
